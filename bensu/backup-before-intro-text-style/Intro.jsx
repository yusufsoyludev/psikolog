    ...
    >
      <div className="relative intro-frame flex items-center justify-center">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none px-4">
          <span className={`intro-text text-primary italic mb-4 ${showWord1 ? 'text-fade visible' : 'text-fade'}`}>
            Ruhunuzda
          </span>
          <span className={`intro-text text-primary italic ${showWord2 ? 'text-fade visible' : 'text-fade'}`}>
            çiçekler açsın
          </span>
        </div>
